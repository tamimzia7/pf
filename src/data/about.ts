...
export const aboutContent: AboutContent = {
  ...
  paragraphs: [
    ...
    "I work across the full stack – from modern web interfaces to backend APIs, database design and system architecture. I specialize in Laravel development, software quality assurance, cyber security, and secure software development. I care about clean, maintainable code and the details that keep software reliable, secure and easy to build on over time.",
  ],
  highlights: [
    ...
    'System Architecture',
    'Software Testing',
    'Bug Detection & Quality Engineering',
